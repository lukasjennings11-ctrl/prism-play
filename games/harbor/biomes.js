...
(function (g) {
  g.HARBOR_BIOMES = {
    green: {
      ...
      skyTop: [0.30, 0.60, 0.94], skyBot: [0.80, 0.92, 1.0], sun: [1.35, 1.24, 1.04], fog: [0.82, 0.91, 0.99], veg: 'tree', vegN: 26,
    ...
    mountain: {
      ...
      skyTop: [0.34, 0.56, 0.84], skyBot: [0.82, 0.90, 0.98], sun: [1.18, 1.18, 1.22], fog: [0.84, 0.90, 0.96], veg: 'pine', vegN: 30,
    ...
    desert: {
      ...
      skyTop: [0.42, 0.66, 0.92], skyBot: [1.0, 0.90, 0.70], sun: [1.42, 1.24, 0.90], fog: [0.98, 0.88, 0.70], veg: 'none', vegN: 0,
    ...
    tropical: {
      ...
      skyTop: [0.24, 0.66, 0.96], skyBot: [0.88, 0.97, 1.0], sun: [1.42, 1.30, 1.08], fog: [0.88, 0.97, 1.0], veg: 'palm', vegN: 24,
    ...
    nordic: {
      ...
      skyTop: [0.46, 0.58, 0.72], skyBot: [0.82, 0.86, 0.92], sun: [1.10, 1.12, 1.20], fog: [0.80, 0.84, 0.90], veg: 'pine', vegN: 22,
